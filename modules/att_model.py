...
class AttModel(CaptionModel):
    def __init__(self, args, tokenizer):
        ...
        self.input_encoding_size = args.d_model  #the dimension of Transformer:512
        self.rnn_size = args.d_ff #the dimension of FFN:512
        self.num_layers = args.num_layers  #3
        self.drop_prob_lm = args.drop_prob_lm #the dropout rate of the output layer:0.5
        self.max_seq_length = args.max_seq_length   #60
        self.att_feat_size = args.d_vf  #the dimension of the patch features:2048
        self.att_hid_size = args.d_model   #512

        self.bos_idx = args.bos_idx   #0
        self.eos_idx = args.eos_idx   #0
        self.pad_idx = args.pad_idx   #0

        self.use_bn = args.use_bn      #0
    ...
    def _sample_beam(self, global_states, fc_feats, att_feats, att_masks=None, opt={}):
        ...
        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks = self._prepare_feature(global_states, fc_feats, att_feats, att_masks)
    ...
    def _sample(self, global_states, fc_feats, att_feats, att_masks=None, update_opts={}):
        ...
        if beam_size > 1 and sample_method in ['greedy', 'beam_search']:
            return self._sample_beam(global_states, fc_feats, att_feats, att_masks, opt)
        if group_size > 1:
            return self._diverse_sample(global_states, fc_feats, att_feats, att_masks, opt)
    ...
    def _diverse_sample(self, global_states, fc_feats, att_feats, att_masks=None, opt={}):
